...
//     const subcategories =
//       isDataAvailable && CollectionsData[selectedCollection]
...
//                     key={index}
//                     onClick={handleClick}
//                     className="hover:bg-gray-100 bg-gray-50 rounded-lg"
//                   >
//                     <img
//                       src={
...
function CollectionMenu() {
  ...
  const handleSubcategoryClick = (collection, subcategory) => {
            ...
            {!isDataAvailable || subcategories.length === 0
              ...
              : subcategories.map((subcategory, index) => (
                  <div
                    key={index}
                    onClick={() =>
                      handleSubcategoryClick(selectedCollection, subcategory)
                    }
                    className="hover:bg-gray-100 bg-gray-50 rounded-lg cursor-pointer"
                  >
                    <img
                      src={
                        subcategory.thumbnail ??
