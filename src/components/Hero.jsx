...
//     isMobile ? mobileBanners[currentImage] : desktopBanners[currentImage]
//   );
...
//       prevIndex === desktopBanners.length - 1 ? 0 : prevIndex + 1
//     );
//     setCurrentBanner(
//       isMobile ? mobileBanners[currentImage] : desktopBanners[currentImage]
//     );
...
//     setDirection(-1);
//     setCurrentImage((prevIndex) =>
//       prevIndex === 0 ? desktopBanners.length - 1 : prevIndex - 1
//     );
//     setCurrentBanner(
//       isMobile ? mobileBanners[currentImage] : desktopBanners[currentImage]
//     );
...
//   return (
//     <div className="relative w-full h-[70vh] md:h-[90vh]  overflow-hidden z-0">
//       {/* Slider Image */}
...
//             </motion.p>
//             <motion.p className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold">
