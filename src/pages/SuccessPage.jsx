  ...
  return (
    <div className="py-20 flex flex-col justify-center items-center bg-gray-100 px-6">
      <div className="bg-white shadow-lg rounded-lg p-8 text-center">
        ...
        {/* 🎉 Success Message */}
        <h2 className="text-2xl font-bold text-gray-800 mt-6">Order Successful!</h2>
        <p className="text-gray-600 mt-2">Thank you for your purchase. Your order has been placed successfully.</p>

        {/* 📦 Order Details (Example) */}
        <div className="mt-4 bg-gray-100 p-4 rounded-md">
          <p className="text-sm text-gray-700"><span className="font-semibold">Order ID:</span> #123456</p>
          <p className="text-sm text-gray-700"><span className="font-semibold">Estimated Delivery:</span> 3-5 Business Days</p>
        </div>
