        ...
        <div className="h-[70vh] flex items-center justify-center bg-gray-50">
            <div className="max-w-md w-full p-8 bg-white rounded-lg shadow">
                ...
                <form onSubmit={handleSubmit}>
                    {errors.form && (
                        <div className="text-red-600 text-sm text-center mb-3">{errors.form}</div>
                    )}
                    <div className="flex flex-col gap-3 mb-5">
                        <div className="flex gap-3">
                            <div className="w-full">
                                <input
                                    className={`border rounded py-1.5 px-3.5 w-full ${errors.firstName ? 'border-red-500' : 'border-gray-300'}`}
                                    type="text"
                                    value={firstName}
                            ...
                            <div className="w-full">
                                <input
                                    className={`border rounded py-1.5 px-3.5 w-full ${errors.lastName ? 'border-red-500' : 'border-gray-300'}`}
                                    type="text"
                                    value={lastName}
                        ...
                        <div>
                            <input
                                className={`border rounded py-1.5 px-3.5 w-full ${errors.email ? 'border-red-500' : 'border-gray-300'}`}
                                type="email"
                                value={email}
                        ...
                        <div>
                            <input
                                className={`border rounded py-1.5 px-3.5 w-full ${errors.password ? 'border-red-500' : 'border-gray-300'}`}
                                type="password"
                                value={password}
                        ...
                        <div>
                            <input
                                className={`border rounded py-1.5 px-3.5 w-full ${errors.phone ? 'border-red-500' : 'border-gray-300'}`}
                                type="text"
                                value={phone}
